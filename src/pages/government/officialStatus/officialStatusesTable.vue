...
export default {
  ...
  methods: {
    ...
    advancedDeleteAlert(item) {
      this.$swal({
        title: `Hapus Status Perangkat "${item.namastatus}"`,
        ...
        if (result.isConfirmed) {
          try {
            await deleteOfficialStatus(item.idstatus);
