  ...
  <div class="modal-overlay" @click="handleOverlayClick">
    <div class="modal-content" @click.stop>
      <div class="modal-header">
        <h5 class="modal-title">{{ isEditMode ? 'Edit Data Pekerjaan' : 'Tambah Data Pekerjaan' }}</h5>
        ...
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            ...
            <input 
              ...
              v-model="formData.namapekerjaan" required>
          </div>
...
<script>
import { addOccupation, updateOccupation } from '@/services/referensi/occupations';
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        this.toast.error("Gagal menyimpan data pekerjaan", { icon: 'fa fa-times' });
      } finally {
