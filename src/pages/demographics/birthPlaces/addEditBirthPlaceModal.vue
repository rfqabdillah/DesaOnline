  ...
  <div class="modal-overlay" @click="handleOverlayClick">
    <div class="modal-content" @click.stop>
      <div class="modal-header">
        <h5 class="modal-title">{{ isEditMode ? 'Edit Data Tempat Dilahirkan' : 'Tambah Data Tempat Dilahirkan' }}</h5>
      ...
      <div class="modal-body">
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            <label for="namatempatdilahirkan" class="form-label">Nama Tempat Dilahirkan</label>
            <input 
              type="text" 
              class="form-control" 
              id="namaTempatDilahirkan" 
              placeholder="Masukkan tempat dilahirkan"
              v-model="formData.namatempatdilahirkan" required>
          </div>
...
<script>
import { addBirthPlace, updateBirthPlace } from '@/services/referensi/birthPlaces';
import { useToast } from "vue-toastification";

export default {
  name: 'editBirthPlaceModal',
  props: {
    birthPlaceToEdit: {
      type: Object,
      default: null
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        this.toast.error("Gagal menyimpan data tempat dilahirkan", { icon: 'fa fa-times' });
      } finally {
