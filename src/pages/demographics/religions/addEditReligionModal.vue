  ...
  <div class="modal-overlay" @click="handleOverlayClick">
    <div class="modal-content" @click.stop>
      <div class="modal-header">
        <h5 class="modal-title">{{ isEditMode ? 'Edit Data Agama' : 'Tambah data Agama' }}</h5>
        ...
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            ...
            <input 
              ...
              v-model="formData.namaagama" required>
          </div>
...
<script>
import { addReligion, updateReligion } from '@/services/referensi/religions';
import { useToast } from "vue-toastification";

export default {
  name: 'editReligionModal',
  props: {
    religionToEdit: {
      type: Object,
      default: null
  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        if (this.isEditMode) {
          // DIUBAH: Menggunakan this.formData
          await updateReligion(this.religionToEdit.idagama, this.formData);
          this.toast.success("Data agama berhasil diperbarui", { icon: 'fa fa-check' });
        } else {
          // DIUBAH: Menggunakan this.formData
          await addReligion(this.formData);
          this.toast.success("Data agama berhasil ditambah", { icon: 'fa fa-check' });
        }
        ...
        this.toast.error("Gagal menyimpan data agama", { icon: 'fa fa-times' });
      } finally {
