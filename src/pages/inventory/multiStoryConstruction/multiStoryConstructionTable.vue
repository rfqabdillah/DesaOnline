  ...
  <div class="col-sm-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3>Daftar Nama Konstruksi Bertingkat</h3>
      </div>
      ...
      <div class="card-body">
        ...
        <div v-if="isFilterVisible" class="border p-3 mb-3 rounded filter-section">
          <div class="row g-2">
            <div class="col-md-4">
              <label for="filterName" class="form-label">Nama Konstruksi Bertingkat</label>
...
export default {
  ...
  data() {
    return {
      ...
      sortColumn: 'namakonstruksibertingkat',
      sortDirection: 'asc',
  ...
  methods: {
    ...
    advancedDeleteAlert(item) {
      this.$swal({
        title: `Hapus Konstruksi Bertingkat "${item.namakonstruksibertingkat}"`,
        ...
        if (result.isConfirmed) {
          try {
            await deleteMultiStoryConstruction(item.idkonstruksibertingkat);
    ...
    resetFilters() {
      ...
      this.sortColumn = 'namakonstruksibertingkat';
      this.sortDirection = 'asc';
      this.currentPage = 1;
      this.fetchMultiStoryConstructions();
    },
