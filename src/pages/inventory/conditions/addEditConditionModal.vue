  ...
  <div class="modal-overlay" @click="handleOverlayClick">
    <div class="modal-content" @click.stop>
      <div class="modal-header">
        <h5 class="modal-title">{{ isEditMode ? 'Edit Data Kondisi' : 'Tambah Data Kondisi' }}</h5>
        ...
        <form @submit.prevent="submitForm">
          <div class="mb-3">
            ...
            <input 
              ...
              v-model="formData.namakondisi" required>
          </div>
...
<script>
import { addCondition, updateCondition } from '@/services/referensi/conditions';
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const { namakondisi } = this.formData;
      if ( !namakondisi ) {
      ...
      try {
        if (this.isEditMode) {
          // DIUBAH: Menggunakan this.formData
          await updateCondition(this.conditionToEdit.idkondisi, this.formData);
          this.toast.success("Data kondisi berhasil diperbarui", { icon: 'fa fa-check' });
        } else {
          // DIUBAH: Menggunakan this.formData
          await addCondition(this.formData);
          this.toast.success("Data kondisi berhasil ditambah", { icon: 'fa fa-check' });
        }
        ...
        this.toast.error("Gagal menyimpan data kondisi", { icon: 'fa fa-times' });
      } finally {
