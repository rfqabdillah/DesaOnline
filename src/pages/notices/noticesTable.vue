      ...
      <div class="card-body">
        ...
        <div v-if="isFilterVisible" class="border p-3 mb-3 rounded filter-section">
          <div class="row g-3">
            ...
            <div class="col-md-3">
              <label for="filterAddress" class="form-label">Konten</label>
              <input type="text" id="filterAddress" class="form-control" v-model="filters.konten" placeholder="Filter berdasarkan konten">
            </div>
      ...
      <div class="table-responsive signal-table">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <template v-else>
              <tr v-for="(item, index) in paginatedNotices" :key="item.idusaha">
